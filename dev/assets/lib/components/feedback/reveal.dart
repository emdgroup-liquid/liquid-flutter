      ...
      demo: LdAutoSpace(
        children: [
                    ...
                    footer: Row(
                      children: [
                        LdReveal(
                          ...
                          child: Row(
                            children: [
                              LdButton(child: const Text("Appearching button"), onPressed: () {}),
                              ldSpacerS,
                            ],
                          ),
                        ),
                        Flexible(child: LdText.p("Some actions might reveal")),
                      ],
                    ),
                    child: LdText.hs("This will stay at all times"),
                  ),
                  LdText.p(
                    "It's about managing expectations tiger team it is all exactly as i said, but i don't like it. Let's unpack that later we should leverage existing asserts that ladder up to the message.",
                  ),
                  ...
                  LdReveal(
                    ...
                    child: Padding(
                      ...
                      child: LdCard(
                        child: LdAutoSpace(
                          children: [
                            const LdText("This is some content that is revealed when the switch is on"),
                            LdButton(child: const Text("Hello world"), onPressed: () {}),
                          ],
                        ),
                      ),
                    ),
                  ),
                  const LdCard(child: Text("Static card that will always be here")),
                ],
              ),
            ),
          ),
          ...
          LdSwitch<double>(
            ...
            children: {0: const Text("0"), 10: const Text("10"), 20: const Text("20"), 50: const Text("50")},
          ),
          Row(
            children: [
              Expanded(
