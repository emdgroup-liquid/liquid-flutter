...
abstract class LiquidLocalizations {
  ...
  static const List<Locale> supportedLocales = <Locale>[Locale('en'), Locale('de')];
...
LiquidLocalizations lookupLiquidLocalizations(Locale locale) {
  ...
  switch (locale.languageCode) {
    case 'de':
      return LiquidLocalizationsDe();
    case 'en':
      return LiquidLocalizationsEn();
  }

  throw FlutterError('LiquidLocalizations.delegate failed to load unsupported locale "$locale". This is likely '
