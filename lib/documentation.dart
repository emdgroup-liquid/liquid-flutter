...
const ldDocComponents = [
  ...
  LdDocComponent(
    ...
    isNullSafe: true,
    description:
        ' A status indicator that can have different states (success, info, error, warning, neutral) and three sizes (small, medium, large)',
    properties: [
      LdDocProperty(
        name: 'child',
        type: 'Widget',
  ...
  LdDocComponent(
    name: 'LdAnimation',
    isNullSafe: true,
    description: ' a collection of animated icons/illustrations.',
    properties: [
      LdDocProperty(
        name: 'color',
        type: 'Color?',
