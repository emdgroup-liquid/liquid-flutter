...
const ldDocComponents = [
  ...
  LdDocComponent(
    ...
    properties: [
      ...
      LdDocProperty(
        name: 'builder',
        type: '_LdMasterDetailBuilder<T, MasterDetailController<T>>',
        description: '',
        features: ['final'],
      ),
      LdDocProperty(
  ...
  LdDocComponent(
    name: 'CrudMasterDetailController',
    isNullSafe: true,
    description: '',
    properties: [
      LdDocProperty(
    ...
    constructors: [
      LdDocConstructor(
        ...
        signature: [
          ...
          LdDocParameter(
            name: 'builder',
            type: 'LdCrudMasterDetailBuilder<T>',
            description: '',
            named: true,
            required: true,
          ),
  ...
  LdDocComponent(
    name: 'LdCrudMasterDetailBuilder',
    isNullSafe: true,
    description: '',
    properties: [],
    constructors: [
  ...
  LdDocComponent(
    ...
    properties: [
      LdDocProperty(
        name: 'itemStates',
        type: 'Map<dynamic, CrudItemState<T>>',
        description: '',
        features: ['final'],
      )
    ],
