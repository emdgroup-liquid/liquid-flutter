...
class Element implements Node {
  ...
  /// Source offset (in the original document string) of this element's start.
  int? sourceOffset;

  /// Length (in the original document string) of this element's source span.
  int? sourceLength;
...
class Text implements Node {
  ...
  /// Source offset (in the original document string) of this text node.
  int? sourceOffset;

  /// Length (in the original document string) of this text node's source span.
  int? sourceLength;
...
class UnparsedContent implements Node {
  ...
  /// Source offset (in the original document string) where this content starts.
  int? sourceOffset;

  /// Length (in the original document string) of this content's source span.
  int? sourceLength;
