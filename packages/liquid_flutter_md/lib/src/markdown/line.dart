...
class Line {
  ...
  /// The byte offset of the first character of this line in the original
  /// source string, or `null` if not tracked.
  final int? charOffset;

  Line(this.content, {this.tabRemaining, this.charOffset})
