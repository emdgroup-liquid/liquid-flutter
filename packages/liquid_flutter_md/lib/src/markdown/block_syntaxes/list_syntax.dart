  ...
  Node parse(BlockParser parser) {
    ...
    while (!parser.isDone) {
      ...
      if (parser.current.isBlankLine) {
        // Blank lines carry their original charOffset from the block parser.
        ...
        // Preserve charOffset adjusted by the number of chars stripped.
        ...
        childLines.add(
          Line(
            ...
            charOffset: parser.current.charOffset != null
                ? parser.current.charOffset! + indentedLine.stripCount
                : null,
          ),
        );
        ...
        // charOffset for the first content line: line start + content start pos.
        childLines.add(Line(
          content,
          tabRemaining: containsTab ? 2 : null,
          charOffset: parser.current.charOffset != null &&
                  contentBlockStart != null
              ? parser.current.charOffset! + contentBlockStart
              : null,
        ));
        ...
        // Lazy continuation lines carry their original charOffset.
        childLines.add(parser.current);
      }
      parser.advance();
    }
