...
const components = [
  ...
  _Component("Slider (Confirmation)", "/components/slider", LucideIcons.gitCommitHorizontal, ComponentCategory.formElements),
  _Component("Slider (Value)", "/components/value-slider", LucideIcons.slidersHorizontal, ComponentCategory.formElements),
