...
class _AccordionDemoState extends State<AccordionDemo> {
  ...
  void _toggleFlatCard(bool newState) {
    setState(() {
      _flatCard = newState;
    });
  }

  void _toggleOnSurface(bool newState) {
    setState(() {
      _onSurface = newState;
    });
  }

  void _toggleAllowMultiple(bool newState) {
    setState(() {
      _allowMultiple = newState;
    });
  }

  void _toggleWrapActiveInCard(bool newState) {
    setState(() {
