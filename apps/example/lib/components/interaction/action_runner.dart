...
class _ActionRunnerDemoState extends State<ActionRunnerDemo> {
  ...
  Widget build(BuildContext context) {
    return ComponentPage(
        ...
        text: 'Can be used to display a multi step process with logs and status indicators.',
        demo: LdCard(
          child: LdAutoSpace(
            animate: true,
            children: [
                ...
                children: [
                  Row(
                    children: [
                      ...
                      ldSpacerS,
                      LdButton.outline(child: const Text("Cancel"), onPressed: () {}),
                    ],
                  ),
                  const LdRunnerLog(
                    messages: [
              ...
              const LdRunnerStep(
                  title: Text("Wont execute"), status: LdIndicatorType.canceled, disabled: true, children: [])
            ],
          ),
        ));
  }
