...
class _ButtonDemoState extends State<ButtonDemo> {
  ...
  Widget build(BuildContext context) {
    return ComponentPage(
      ...
      title: "LdButton",
      apiComponents: const ["LdButton", "LdButtonGhost", "LdButtonConfig", "LdButtonConfigProvider"],
      demo: LdAutoSpace(
        ...
        children: [
          ...
          LdBundle(
            children: [
              LdText.hs("Leading and trailing widgets"),
              LdText.p("You can add a leading or trailing widget to a button"),
              ComponentWell(
                child: Column(
                  children: [
                    ldSpacerL,
          ...
          LdBundle(
            children: [
              LdText.h("Disabled"),
              const LdText("You can disable a button by setting the disabled property to true"),
              ComponentWell(
                child: Column(
                  children: [
                    /*begin demo:LdButtonDisabled*/
                    LdButton(onPressed: () {}, disabled: true, child: const Text("Primary")),
