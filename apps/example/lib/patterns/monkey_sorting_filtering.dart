...
class MonkeySortingFilteringDemo extends StatelessWidget {
    ...
    return ComponentPage(
      ...
      demo: LdAutoSpace(
        children: [
          ...
          LdText.p(
            "Allow users to filter items based on different criteria. The monkey pattern supports several types of filters:",
          ),
  ...
  // ... other configuration
          ...
          CodeBlock(
            language: "dart",
            code: '''// URL will look like: /task-demo?filters=done,todo&sort=due&search=important
...
// 4. Restores state when navigating back''',
          ...
          LdText.p("The monkey pattern provides built-in UI components for managing filters:"),
